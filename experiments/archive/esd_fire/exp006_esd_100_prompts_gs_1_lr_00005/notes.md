...
thread: esd_fire
takeaway: >
  Best erasure of the ESD era: on the 100-prompt fire set, FDR ~0.6 with most videos keeping
  their color. Its step-1000 LoRA became the theta* reference for the unhype controls.
---
