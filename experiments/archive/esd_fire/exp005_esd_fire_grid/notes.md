...
thread: esd_fire
takeaway: >
  First ESD grid. Runs reaching FDR=0 got there by desaturating, not erasing — higher
  guidance/lr erase faster but degrade CLIP further. Read as quality collapse, not removal.
---
