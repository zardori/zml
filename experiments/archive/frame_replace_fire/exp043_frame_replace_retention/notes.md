...
takeaway: >
  Added the retention anchor. Preservation held (unrelated clip ~0.32-0.34, no crater) but zero
  erasure: concept FDR 0.6-1.0 and loss_erase flat at ~0.07 from step 49 on.
---
...
4. **Train**: `./submit_job.py athena experiments/archive/frame_replace_fire/exp043_frame_replace_retention/config.yaml`
