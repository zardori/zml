...
takeaway: >
  Motion audit of eta=2 against a real base-model baseline. Found eta=2 erases partly by
  freezing the video, and the damage is global: motion -84% on concept, -43% related, -29%
  unrelated, while clip and colorfulness see nothing.
---
