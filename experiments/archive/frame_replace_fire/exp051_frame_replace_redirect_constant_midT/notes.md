...
takeaway: >
  Redirection with constant LR and a mid/high-t timestep bias. Outcome never written up.
---
...
`./submit_job.py athena experiments/archive/frame_replace_fire/exp051_frame_replace_redirect_constant_midT/config.yaml`
