...
takeaway: >
  x0-space erase loss. Still no erasure; with exp043/044 this shows edited-latent reconstruction
  SFT cannot erase fire regardless of loss space, masking or weighting.
---
...
- **Train**: `./submit_job.py athena experiments/archive/frame_replace_fire/exp045_frame_replace_x0loss/config.yaml`
