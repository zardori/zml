...
takeaway: >
  Verification of exp046's step-500 checkpoint on the full 15-prompt fire set, and the run that
  introduced the hard related set cogvideox_fire_control_related_v2.csv. Outcome never written
  up.
---
...
## Pipeline
`./submit_job.py athena experiments/archive/frame_replace_fire/exp047_eval_exp046_step_500/config.yaml`
