...
takeaway: >
  Masked erase loss over fire frames only. The mask was inert — loss step-for-step identical to
  exp043 — proving fire and non-fire frames carry equal velocity-MSE. Then diverged and
  collapsed at step 1000.
---
...
- **Train**: `./submit_job.py athena experiments/archive/frame_replace_fire/exp044_frame_replace_masked/config.yaml`
