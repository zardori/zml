...
thread: unhype
takeaway: >
  Averaged the removal target over K=8 timestep snapshots to cut variance. Cosine only 0.99 ->
  0.97 — the dominant variance source was elsewhere (prompt conditioning).
---
