...
thread: unhype
takeaway: >
  Static-apply control, zero training: injecting theta* directly erases fire (FDR 0.6,
  colorfulness 22.6 -> 9.0) while unrelated holds. Proves the decode/apply/eval path is sound,
  so every exp024-exp028 failure is upstream in the online learning signal.
---
