...
thread: unhype
takeaway: >
  First run on the fixed init, simulated_lr 0.005 -> 0.3. Still a no-op adapter (FDR 1.0, theta
  frozen at init) — the MSE gradient-matching target could not move theta.
---
