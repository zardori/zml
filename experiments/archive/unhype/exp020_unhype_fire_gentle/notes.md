...
thread: unhype
takeaway: >
  Gentle (preservation-first) setting. No change vs base — two compounding bugs: constant-output
  hypernet init and a simulated_lr ~40-200x too small.
---
...
training) in `experiments/archive/unhype/exp021_unhype_fire_moderate/notes.md`.
