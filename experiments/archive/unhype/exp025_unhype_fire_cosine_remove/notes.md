...
thread: unhype
takeaway: >
  Cosine removal loss to decouple direction from magnitude. The adapter finally moved (theta
  15.16 -> 17.06, videos changed) but in the wrong direction — no erasure.
---
