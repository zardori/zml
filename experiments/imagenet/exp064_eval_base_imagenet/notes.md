...
`./submit_job.py athena experiments/imagenet/exp064_eval_base_imagenet/config.yaml`
...
- **exp066 yield risk.** 5 of 20 full-concept chain-saw clips have *no* frame above 0.05, and a split
  ...
  triples. If fewer than ~12 survive review, extend `prompts/imagenet_objects/split/chain_saw.csv` rather
