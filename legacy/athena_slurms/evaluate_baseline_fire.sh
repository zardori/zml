#!/bin/bash
#SBATCH --job-name=evaluate_fire
#SBATCH --output=./logs/evaluate_fire_%j.out
#SBATCH --error=./logs/evaluate_fire_%j.err
#SBATCH --nodes=1
...
export OUTPUT_DIR=outputs/evaluate_baseline_fire_${TIMESTAMP}
mkdir -p "$OUTPUT_DIR"
